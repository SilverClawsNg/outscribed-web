...
import { ref } from 'vue';
import { 
  getValidCountry, getValidCategory, getValidSortType, getValidInsightStatus
} from '@/utils/validators'; 

export const useInsightDraftFilterStore = defineStore('insightDraftFilter', () => {
...
const status = ref<string | null>(null)
  ...
  if(queryParameters.country){
    ...
    const validatedStatus = getValidInsightStatus(queryParameters.status)
