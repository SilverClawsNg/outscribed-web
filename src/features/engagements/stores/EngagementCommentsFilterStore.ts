...
import { ref } from 'vue';
import { 
  getValidCommentStatus, getValidContentType, getValidSortType, getValidVoteType
} from '@/utils/validators'; 

export const useEngagementCommentsFilterStore = defineStore('engagementCommentsFilter', () => {
...
function getAsDictionary(): Record<string, string> {
  ...
  return {
    sort, status, contenttype, votetype, username, keyword, pointer,
