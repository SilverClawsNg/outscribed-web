...
import { useDraftCommentsFilterStore } from '../stores/DraftCommentsFilterStore'
import { useModalStore } from '@/stores/modalStore'
import { SortTypeSelectItems, LimitedContentTypeSelectItems, 
  CommentStatusSelectItems } from '@/utils/selectItemHelper'
      ...
      <section>
        ...
        <fieldset>
                <select v-model="filterStore.status" class="form-field">
                    ...
                    <option v-for="item in CommentStatusSelectItems" :key="item.value" :value="item.value">
                    {{ item.label }}
                    </option>
                </select>
            </fieldset>
